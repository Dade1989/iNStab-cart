...
! -- singular
      id_real(matrID)%ICNTL(24) = 1
      id_real(matrID)%ICNTL(25) = 0
!      id_real(matrID)%CNTL(3) = 0.0
!      id_real(matrID)%CNTL(5) = 10.0e20
...
! -- singular
         WRITE(*,*) " INFOG(28) = " ,  id_real(matrID)%INFOG(28)
      ELSE
         CALL mumps_status(id_real(matrID)%INFOG(1))
      ENDIF
...
!---->
      ...
      WRITE (*,*) 'CNTL(5) = ' , id_real(matrID)%CNTL(5)
