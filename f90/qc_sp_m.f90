...
INTERFACE qc_adjointOseen2_sp_M
  MODULE PROCEDURE qc_adjointOseen2_sp_M_real , &
                   qc_adjointOseen2_sp_M_cmplx
END INTERFACE qc_adjointOseen2_sp_M
...
SUBROUTINE Dirichlet_c_Mz (np, js_D,  CC)
!=======================================
...
END SUBROUTINE Dirichlet_c_Mz

!------------------------------------------------------------------------------

SUBROUTINE Dirichlet_rc_Mz (np, js_D, diagE,  CC)
!=======================================
...
END SUBROUTINE Dirichlet_rc_Mz
...
SUBROUTINE qc_adjointOseen2_sp_M_real (m0, jj, gg,  CC) 
!==========================================

!  ACCUMULATES CONTRIBUTIONS ONLY TO DIAGONAL BLOCKS

!  -  << w, (g.D)_ >>  +  << w, (Dg)._ >>   ===>   CC    /ALL VECTORS/
!    
!  ACCUMULATES CONTRIBUTIONS TO ALL FOUR VELOCITY BLOCKS
!                      
!  ===>   CC   cumulative      
...
END SUBROUTINE qc_adjointOseen2_sp_M_real
!--------------------------------------------------------------------

SUBROUTINE qc_adjointOseen2_sp_M_cmplx (m0, jj, gg,  CC) 
!==========================================
...
END SUBROUTINE qc_adjointOseen2_sp_M_cmplx
